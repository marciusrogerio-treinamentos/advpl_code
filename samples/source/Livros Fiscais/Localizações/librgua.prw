...
Local cSerieUlt  := Space(SerieNfId("SF3",6,"F3_SERIE"))
Local cTipoNFAtu := ""
Local cTipoNCCAtu:= ""
...
Else
	...
	cCposSF3  := "F3_FILIAL,F3_ENTRADA,F3_NFISCAL,"+SerieNfId('SF3',3,'F3_SERIE')+",F3_CLIEFOR,F3_LOJA,"
       ...
       While !Eof() .And. F3_ENTRADA == dDataAtu
		  ...
		  If AllTrim(F3_ESPECIE) $ "NF|NDC"
		     ...
		     If cTipoNFAtu == "N"
		        ...
		        If nPosNF == 0		        
	   		       AAdd(aNFS,{F3_FILIAL,F3_ENTRADA,"1",F3_NFISCAL,SerieNfId(cAliasSF3,2,'F3_SERIE'),Space(TamSX3("F3_NFISCAL")[1]),;
	   		                   Space(SerieNfId('SF3',6,'F3_SERIE')),F3_VALCONT,FieldGet(FieldPos(cCpoBAS)),FieldGet(FieldPos(cCpoVAL)),F3_EXENTAS})	   		   
                Else
		     ...
		     Else
		        ...
		        If nPosNF == 0
	   		       AAdd(aNFS,{F3_FILIAL,F3_ENTRADA,"2",F3_NFISCAL,SerieNfId(cAliasSF3,2,'F3_SERIE'),Space(TamSX3("F3_NFISCAL")[1]),;
	   		                  Space(SerieNfId('SF3',6,'F3_SERIE')),F3_VALCONT,FieldGet(FieldPos(cCpoBAS)),FieldGet(FieldPos(cCpoVAL)),F3_EXENTAS})	   		   
                Else
                   aNFS[nPosNF][8]  += F3_VALCONT
                   aNFS[nPosNF][9]  += FieldGet(FieldPos(cCpoBAS))
		     ...
		     cSerieUlt   := SerieNfId(cAliasSF3,2,'F3_SERIE')	//F3_SERIE
		     cTipoNF     := cTipoNFAtu
		     cFilAtu     := F3_FILIAL
		  ...
		  ElseIf AllTrim(F3_ESPECIE) == "NCC" 
		     ...
		     If cTipoNFAtu == "N"
		        ...
		        If nPosNCC == 0		        
	   		       AAdd(aNCC,{F3_FILIAL,F3_ENTRADA,"1",F3_NFISCAL,SerieNfId(cAliasSF3,2,'F3_SERIE'),Space(TamSX3("F3_NFISCAL")[1]),;
	   		                   Space(SerieNfId(cAliasSF3,6,'F3_SERIE')),F3_VALCONT,FieldGet(FieldPos(cCpoBAS)),FieldGet(FieldPos(cCpoVAL)),F3_EXENTAS})	   		   
                Else
		     ...
		     Else
		        ...
		        If nPosNCC == 0
	   		       AAdd(aNCC,{F3_FILIAL,F3_ENTRADA,"2",F3_NFISCAL,SerieNfId(cAliasSF3,2,'F3_SERIE'),Space(TamSX3("F3_NFISCAL")[1]),;
	   		                  Space(SerieNfId(cAliasSF3,6,'F3_SERIE')),F3_VALCONT,FieldGet(FieldPos(cCpoBAS)),FieldGet(FieldPos(cCpoVAL)),F3_EXENTAS})	   		   
                Else
                   aNCC[nPosNCC][08] += F3_VALCONT
                   aNCC[nPosNCC][09] += FieldGet(FieldPos(cCpoBAS))
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function LibGVldMes(cMes)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function LibGVldAno(cAno)
