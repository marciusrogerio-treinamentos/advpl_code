...
While !Eof()
	...
	If Empty( (cAliasSF3)->F3_DTCANC )		//NF Nao Cancelada
		...
		If !lVenda	//Compra
			SERIE	:= SerieNfId(cAliasSF3,2,'F3_SERIE')
...
DO WHILE !SF3->( Eof() )
	...
	IF ! Empty( F3_DTCANC )
		@ nLin, IF( !lVenda, 81, 11 ) PSAY SerieNfId('SF3',2,'F3_SERIE')+' '+F3_NFISCAL	
	...
	IF !lVenda
		...
		@ nLin,081 PSAY SerieNfId('SF3',2,'F3_SERIE')+' '+F3_NFISCAL	
	...
	ELSE
		@ nLin,012 PSAY SerieNfId('SF3',2,'F3_SERIE')+F3_NFISCAL	
