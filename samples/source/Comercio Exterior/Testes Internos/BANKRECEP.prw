...
//o trecho abaixo se compilado força erro de integração para testes
/*lRet := .F. 
cXMLRet := "<Error>"+"Retorno de Erro Para testes - Integraçao da transação bancária de inclusão de contrato"+"</Error>"*/
