...
Do While .T.
   ...
   DEFINE MSDIALOG oDlg TITLE cTitulo4; 
      ...
      @ 00,00 MsPanel oPanelTop Prompt "" Size 19,41 of oPanel //LRL 24/03/04 Painel do Topo p/ alinhamento MDI
      @ 15,004 SAY IF(nAnuente==1,STR0006,STR0053) SIZE 45,8 of oPanel Pixel //"Nro. da PLI:" //"Processo:"
      IF nAnuente ==1
      ...
      @ 15,097 SAY OemToAnsi(STR0028) SIZE 50,8 Of Opanel Pixel //"Nro. do PO:"
      IF nAnuente ==1
         @ 15,130 GET Work1->W5_PO_NUM PICTURE "@!" SIZE 40,8 Of Opanel Pixel WHEN .F.
      ELSE
         @ 15,130 GET Work1->W7_PO_NUM PICTURE "@!" SIZE 40,8 Of Opanel Pixel WHEN .F.
      ENDIF

      @ 27,004 SAY OemToAnsi(STR0029)  SIZE 50,8 Of Opanel Pixel //"Unid.Requis.:"
      IF nAnuente ==1 
         @ 27,040 GET Work1->W5_CC PICTURE "@!" SIZE 30,8 Of Opanel Pixel WHEN .F.
      ELSE
         @ 27,040 GET Work1->W7_CC PICTURE "@!" SIZE 30,8 Of Opanel Pixel WHEN .F.
      ENDIF

      @ 27,097 SAY OemToAnsi(STR0030)  SIZE 45,8 Pixel //"Nro. da SI:"
      IF nAnuente ==1
        @ 27,130 GET Work1->W5_SI_NUM PICTURE "@!" SIZE 30,8 Of Opanel Pixel WHEN .F.
      ELSE
        @ 27,130 GET Work1->W7_SI_NUM PICTURE "@!" SIZE 30,8 Of Opanel Pixel WHEN .F.
      ENDIF

      @ 39,004 SAY OemToAnsi(STR0031)  SIZE 45,8 Of Opanel Pixel //"Cod. Item:"
      IF nAnuente ==1 
         @ 39,040 GET Work1->W5_COD_I PICTURE "@!" SIZE 45,8 Of Opanel Pixel WHEN .F.
      ELSE
         @ 39,040 GET Work1->W7_COD_I PICTURE "@!" SIZE 45,8 Of Opanel Pixel WHEN .F.
      ENDIF

      @ 39,097 SAY OemToAnsi(STR0032)  SIZE 45,8 Of Opanel Pixel //"Descr.Item:"
      
      xAux := LOTECodProd(IF(nAnuente==1,Work1->W5_COD_I,Work1->W7_COD_I))
      @ 39,130 GET xAux PICTURE "@!" SIZE 105,8 Of Opanel Pixel WHEN .F.

      @ 15,198 SAY OemToAnsi(STR0033)  SIZE 45,8 Of Opanel Pixel //"Qtde. Item:"
      IF nAnuente == 1
         @ 15,232 GET Work1->W5_QTDE PICTURE AVSX3("W5_QTDE",6)  SIZE 70,8 Of Opanel Pixel WHEN .F.
      ELSE
         @ 15,232 GET Work1->W7_QTDE PICTURE  AVSX3("W7_QTDE",6) SIZE 70,8 Of Opanel Pixel WHEN .F.
      ENDIF

      @ 27,198 SAY OemToAnsi(STR0034)  SIZE 45,8 Of Opanel Pixel //"Saldo Item:"
      @ 27,232 GET nSaldo PICTURE AVSX3("WV_QTDE",6) SIZE 70,8 Of Opanel Pixel WHEN .F.
